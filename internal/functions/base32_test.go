...
func TestBase32Function(t *testing.T) {
	t.Parallel()

	fn := NewBase32Function()
	...
	cases := []struct {
		...
		{name: "valid 1", value: types.StringValue("NBSWY3DP"), expectTrue: true},
		{name: "valid 2", value: types.StringValue("OZQWY2LEMF2GK==="), expectTrue: true},
		{name: "invalid", value: types.StringValue("not-base32"), expectError: true},
