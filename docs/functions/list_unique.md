...
page_title: "list_unique function - terraform-provider-validatefx"
subcategory: ""
description: |-
...
Returns true when all elements in the list are unique (no duplicates).
...
```text
list_unique(values list of string) bool
```
